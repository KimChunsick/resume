...
interface WorkExperienceData {
  ...
  team: string
  description: string
  experiences: { title: string; date: string; description: string; summary: string[] }[]
}
